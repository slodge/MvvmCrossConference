...
namespace Cirrious.Conference.UI.Touch
{
    public partial class MapView : MvxBindingTouchViewController<MapViewModel>
    {
        public MapView(MvxShowViewModelRequest request)
            : base(request, AppDelegate.IsPad ? "MapView_iPad" : "MapView", null)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            var map = AppDelegate.IsPad ? new MKMapView(new RectangleF(20, 300, UIScreen.MainScreen.Bounds.Width - 40, 600)) : new MKMapView(new RectangleF(20, 166, 280, 192));
            this.View.Add(map);
